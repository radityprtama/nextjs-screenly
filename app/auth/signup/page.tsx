      ...
      <form onSubmit={onSubmit} className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <ModernInput
            ...
            icon={<Lock size={20} />}
            error={confirmPassword && password !== confirmPassword ? 'Password tidak sama' : undefined}
            required
          />
        </div>
        ...
        <div className="space-y-4">
          <label className="flex items-start gap-3">
            ...
            <span className="text-sm text-gray-300 leading-relaxed">
              I agree to the{' '}
              <Link href="/terms" className="text-netflix-red hover:text-netflix-red/80">
                Terms of Service
              </Link>{' '}
              and{' '}
              <Link href="/privacy" className="text-netflix-red hover:text-netflix-red/80">
                Privacy Policy
              </Link>
            </span>
          </label>
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-netflix-black text-gray-400">Or sign up with</span>
          </div>
        </div>
